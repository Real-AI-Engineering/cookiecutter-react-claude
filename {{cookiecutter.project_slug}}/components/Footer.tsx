...
// For Next.js projects, this is a copy of src/components/Footer.tsx
          ...
          <div className="space-y-8 xl:col-span-1">
            <div>
              ...
              <p className="text-gray-600 dark:text-gray-400 text-sm mt-2">
                {% if cookiecutter.use_i18n == "y" -%}{t ? t('footer.description') : '{{cookiecutter.project_description}}'}{% else -%}{{cookiecutter.project_description}}{% endif -%}
              </p>
            </div>
...
// For SPA projects, use src/components/Footer.tsx instead
export const Footer = () => {
  return <div>Next.js Footer Component</div>
}
{% endif -%}