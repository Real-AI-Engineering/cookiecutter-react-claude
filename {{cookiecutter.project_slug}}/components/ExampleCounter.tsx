...
// For Next.js projects, this is a copy of src/components/ExampleCounter.tsx
...
import { increment, decrement, reset } from '../lib/stores/slices/counterSlice'
{% elif cookiecutter.state_management == "zustand" -%}
import { useCounterStore } from '../lib/stores/useStore'
{% endif -%}
...
// For SPA projects, use src/components/ExampleCounter.tsx instead
export const ExampleCounter = () => {
  return <div>Next.js ExampleCounter Component</div>
}
{% endif -%}