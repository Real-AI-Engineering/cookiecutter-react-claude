...
// For Next.js projects, this is a copy of src/components/Hero.tsx
...
// For SPA projects, use src/components/Hero.tsx instead
export const Hero = () => {
  return <div>Next.js Hero Component</div>
}
{% endif -%}